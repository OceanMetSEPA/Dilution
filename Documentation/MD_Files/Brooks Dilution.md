...
$$C(x',y)=\frac{C_0}{2}\left(\mayhem{erf}\left(\frac{\sqrt{U} \left(B+2y\right)}{4\sqrt{{x'\varepsilon_{0}}}}\right) + \mayhem{erf}\left(\frac{\sqrt{U} \left(B - 2y\right)}{4\sqrt{x'\varepsilon_{0}}}\right)\right)
$$

which has a maximum value at $y=0$:
$$C(x',0)=C_0\mayhem{erf}\left(\frac{U B}{4\sqrt{{Ux'\varepsilon_{0}}}}\right)$$

Using the subsitution $\beta=\frac{12\varepsilon_0}{UB}$, the peak concentration is:
$$C(x',0)=C_0\mayhem{erf}\left(\sqrt{\frac{3 B}{4\beta x'}}\right)$$
...
$$\sigma(x')^2=\frac{1}{2B}\int_{-\infty}^{\infty}y^2\left(\mayhem{erf}\left(\frac{\sqrt{U} \left(B+2y\right)}{4\sqrt{{x'\varepsilon_{0}}}}\right) + \mayhem{erf}\left(\frac{\sqrt{U} \left(B-2y\right)}{4\sqrt{x'\varepsilon_{0}}}\right)\right)dy$$
...
$y^2*(\mayhem{erf}(A*(B+2y))+\mayhem{erf}(A*(B-2y)))$
...
Substitute this into peak concentration (which was found in terms of $x'$, i.e.$C(x',0)=C_0\mayhem{erf}\left(\sqrt{\frac{3 B}{4\beta x'}}\right)$) leads to the concentration we want, in terms of $x$:

$$\boxed{C(x,0)=C_0\mayhem{erf}\left(\left[\frac{2 }{3}\left(\left(\frac{(2-n)\beta x}{B} +1\right)^{\frac{2}{2-n}}-1 \right)\right]^{-\frac{1}{2}}\right)}$$
...
|-|-|-|
|0|$\left[1+\frac{2\beta x}{B} \right]^{\frac{1}{2}}$|$\mayhem{erf}\left(\left[\frac{2 }{3}\left(\frac{2\beta x}{B} \right)\right]^{-\frac{1}{2}}\right)$
|1|$\left[1+\frac{\beta x}{B} \right]$|$\mayhem{erf}\left(\left[\frac{2 }{3}\left(\left(\frac{\beta x}{B} +1\right)^{2}-1 \right)\right]^{-\frac{1}{2}}\right)$
|$\frac{4}{3}$|$\left[1+\frac{2\beta x}{3B}\right]^{\frac{3}{2}}$|$\mayhem{erf}\left(\left[\frac{2 }{3}\left(\left(\frac{2\beta x}{3B} +1\right)^{3}-1 \right)\right]^{-\frac{1}{2}}\right)$
...
|$D$|Dilution = $\frac{C_{max}}{C_0}$|1/$\mayhem{erf}\left(\left[\frac{2 }{3}\left(\left(\frac{2\beta x}{3B} +1\right)^{3}-1 \right)\right]^{-\frac{1}{2}}\right)$ for $n=\frac{4}{3}$
...
$$C(x,0)=C_0\mayhem{erf}\left(\left[\frac{2 }{3}\left(\left(\frac{(2-n)\beta x}{B} +1\right)^{\frac{2}{2-n}}-1 \right)\right]^{-\frac{1}{2}}\right)$$

$$D=\frac{C_0}{C(x,0)}=1/\mayhem{erf}\left(\left[\frac{2 }{3}\left(\left(\frac{(2-n)\beta x}{B} +1\right)^{\frac{2}{2-n}}-1 \right)\right]^{-\frac{1}{2}}\right)$$

$$\rightarrow  \boxed{x =\frac{B}{(2-n)\beta}\left[\left(\frac{3 }{2}\left(\mayhem{ierf}\left(\frac{1}{D}\right)\right)^{-2}+1\right)^{\frac{2-n}{2}}-1\right]}$$
...
$$D=\frac{C_0}{C(x',y)}=2/\left(\mayhem{erf}\left(\frac{\sqrt{U} \left(B+2y\right)}{4\sqrt{{x'\varepsilon_{0}}}}\right) + \mayhem{erf}\left(\frac{\sqrt{U} \left(B - 2y\right)}{4\sqrt{x'\varepsilon_{0}}}\right)\right)
$$
...
$S_2=\mayhem{erf}\left(\left[\frac{2 }{3}\left(\left(\frac{2\beta x}{3B} +1\right)^{3}-1 \right)\right]^{-\frac{1}{2}}\right)^{-1}$
